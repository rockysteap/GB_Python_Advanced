# Модуль array
# Ещё один модуль, предоставляющий доступ к типу данных массив.

# Как вы помните список list является массивом ссылок на объекты.
# А сами объекты хранятся отдельно, вне массива.

# array из модуля array является классическим массивом.
...
# Первый аргумент — строковой символ код типа.
#   Буква указывает на то какие данные хранятся в массиве и выделяет нужное число байт под данные.
...
# Массивы поддерживают методы списка list, поэтому использование их интуитивно понятно.
# Привыкать надо лишь к указанию хранимого типа данных.
"""
...
# При этом массив не позволит добавить значение, если оно выходит за пределы диапазона,
# заданного кодом типа при создании. Так же будет поднята ошибка при несоответствии типа.
