...
# Любая многострочная строка после заголовка класса и метода автоматически
# сохраняется в переменную __doc__.
#
# Помимо вызова справки через функцию help можно прочитать отдельный
# многострочник напрямую обратившись к переменной.
