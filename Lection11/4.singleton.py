...
# Ещё один вариант использования __new__ — паттерн Singleton.
# Он позволяет создавать лишь один экземпляр класса.
# Вторая и последующие попытки будут возвращать ранее созданный экземпляр.

# 🔥 Внимание!
# Это не единственный вариант создания паттерна Одиночка в Python,
# а версия через __new__
